...
#| label: gg-theme
#| include: false 
source("_extensions/juliengamartin/blackboard/themes_board.r")
```
...
#| echo: true
ggplot(cars) +
  geom_point(aes(speed,dist), color="white")
```
Given the dark background you need to define the color of the points
